...
import { useWaveformSettingsActions } from '../composables/useWaveformSettingsActions.js'
...
<template>
  <div class="toolbar-waveform">
    ...
    <button @click="zoomIn" title="放大" :disabled="!canZoomIn">🔍+</button>
    <button @click="zoomOut" title="缩小" :disabled="!canZoomOut">🔍-</button>
