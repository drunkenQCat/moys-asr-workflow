...
class EditorAssetTests(unittest.TestCase):
    ...
    def test_blank_editor_inlines_modular_assets(self) -> None:
        ...
        self.assertIn('autoSnapAdjacentCues: saved.autoSnapAdjacentCues === true', page)
        self.assertIn('id="auto-snap-adjacent-cues"> 自动吸附调整相邻字幕', page)
        self.assertNotIn('id="auto-snap-adjacent-cues" checked', page)
